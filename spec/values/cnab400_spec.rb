...
RSpec.describe Cnab400 do
  describe '#kind' do
    it 'returns the kind of transaction' do
      line = '1'
      cnab400 = described_class.new(line)

      expect(cnab400.kind).to be 1
    end
  end
  ...
  describe '#emitted_at' do
    it 'returns the emitted_at of transacion in timezone UTC -3' do
      ...
      expect(cnab400.emitted_at).to eq(Time.parse('2019-03-01 15:34:53').in_time_zone('UTC'))
    end
  end
  ...
  describe '#value' do
    it 'returns the value of transacion' do
      ...
      expect(cnab400.value).to be 142.0
    end
  ...
  describe '#cpf' do
    it 'returns the cpf of transacion' do
      ...
      expect(cnab400.cpf).to eq('09620676017')
    end
  end
  ...
  describe '#card' do
    it 'returns the card number of transacion' do
      ...
      expect(cnab400.card).to eq('4753****3153')
    end
  end
  ...
  describe '#store_owner' do
    it 'returns the store owner of transacion' do
      ...
      expect(cnab400.store_owner).to eq('JOÃO MACEDO')
    end
  end
  ...
  describe '#store_name' do
    it 'returns the store owner of transacion' do
      ...
      expect(cnab400.store_name).to eq('BAR DO JOÃO')
    end
  end
end
